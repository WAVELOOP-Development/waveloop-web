...
export const services: Service[] = [
  ...
  },
  {
    ...
    whyChooseUs: [
      "Award-winning design team with proven track record",
      "User-centered design approach with measurable results",
      "Comprehensive design research and validation",
      "Modern design tools and collaborative workflows",
      "Cross-functional team with technical expertise",
      "Scalable design systems for long-term success",
  ...
  },
  {
    ...
    whyChooseUs: [
      "Certified cybersecurity professionals with industry expertise",
      "Comprehensive security frameworks and methodologies",
      "Latest security technologies and threat intelligence",
  ...
  },
  {
    ...
    whyChooseUs: [
      ...
      "Complete app store submission support",
      "Post-launch optimization and updates",
...

  {
    ...
    whyChooseUs: [
      ...
      "End-to-end AI implementation and support",
  ...
  },
  {
    ...
    whyChooseUs: [
      ...
      "Proven migration and deployment methodologies",
