		...
		content: [
			{
				...
				details:
					'We collect information you provide directly to us, such as when you create an account, subscribe to our newsletter, or contact us. This may include your name, email address, phone number, and any other information you choose to provide.',
			},
			{
				subtitle: 'Usage Information',
				details:
					'We automatically collect certain information about your use of our services, including your IP address, browser type, operating system, access times, and the pages you view.',
			},
			{
		...
		content: [
			{
				...
				details:
					'To provide, maintain, and improve our services, process transactions, and communicate with you about your account or our services.',
			},
			{
				subtitle: 'Personalization',
				details:
					'To personalize your experience, provide customized content, and make recommendations based on your preferences and usage patterns.',
			},
			{
				subtitle: 'Communications',
				details:
					'To send you technical notices, updates, security alerts, and support messages, as well as marketing communications with your consent.',
			},
		],
	},
	{
	...
	},
	{
		...
		content: [
			...
			},
			{
				...
				details:
					'We maintain strict access controls and regularly review our security practices to ensure your data remains protected.',
			},
		],
	},
];
						...
						<div className="flex items-start gap-4">
							...
							<div>
								...
								<p className="text-gray-700 leading-relaxed">
									At Waveloop, we are committed to protecting your privacy and
									...
									believe transparency is key to building trust with our users.
								</p>
							</div>
						</div>
					</div>
				...
				>
					<div className="bg-gradient-to-r from-[#00081C] to-gray-900 rounded-2xl p-8 text-white">
						...
						<p className="text-gray-300 text-center mb-8 max-w-2xl mx-auto">
							You have several rights regarding your personal information. We respect
							these rights and provide easy ways for you to exercise them.
						</p>
					...
					<div className="bg-gray-50 rounded-2xl p-8">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
							...
							<div>
								...
								<p className="text-gray-600">
									We typically retain usage data for up to 2 years for analytics and
							...
							<div>
								...
								<p className="text-gray-600">
									Marketing-related data is retained until you unsubscribe or for a
									maximum of 3 years.
								</p>
							</div>
							<div>
								...
								<p className="text-gray-600">
									Some data may be retained longer when required by law or for
